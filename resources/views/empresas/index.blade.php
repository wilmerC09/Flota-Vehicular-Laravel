        ...
        <section class="content-header" style="padding: 1.5rem 1rem; background: white; border-bottom: 1px solid #e5e7eb;">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 style="font-size: 24px; font-weight: 700; color: #1f2937; margin: 0;">Empresas</h1>
                        <nav style="font-size: 14px; color: #6b7280; margin-top: 4px;"><a href="{{ route('home') }}"
                                ...
                                style="margin: 0 8px;">/</span><span>Empresas</span></nav>
                    </div><a href="{{ route('empresas.create') }}"
                            ...
                            <tbody>
                                @forelse($empresas as $empresa)
                                    <tr style="border-bottom: 1px solid #f3f4f6;">
                                        ...
                                        <td style="padding: 12px 16px; color: #6b7280; font-weight: 600;">{{ $empresa->id }}
                                        </td>
                                        <td style="padding: 12px 16px;">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    style="width: 48px; height: 48px; border-radius: 8px; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); display: flex; align-items: center; justify-content: center; margin-right: 12px; color: white; font-weight: 700;">
                                        ...
                                        <td style="padding: 12px 16px; text-align: center;"><span class="status-badge"
                                                data-id="{{ $empresa->id }}" data-model="empresas"
                                                data-status="{{ $empresa->estado ? '1' : '0' }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center" style="padding: 40px;"><i class="fas fa-inbox"
                                            ...
                                            <p style="color: #9ca3af;">No hay empresas registradas</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
