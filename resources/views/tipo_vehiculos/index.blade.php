        ...
        <section class="content-header" style="padding: 1.5rem 1rem; background: white; border-bottom: 1px solid #e5e7eb;">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 style="font-size: 24px; font-weight: 700; color: #1f2937; margin: 0;">Tipos de Vehículos</h1>
                    ...
                    <a href="{{ route('tipo_vehiculos.create') }}"
                        ...
                        <table class="table table-hover mb-0">
                            <thead style="background: #f9fafb;">
                                <tr>
                                    ...
                                    <th style="padding: 12px 16px; font-weight: 600; font-size: 13px; color: #6b7280;"><i
                                            class="fas fa-truck text-muted mr-1"></i>Nombre</th>
                                    <th style="padding: 12px 16px; font-weight: 600; font-size: 13px; color: #6b7280;"><i
                                    ...
                                    <th
                                        ...
                                        <i class="fas fa-users text-muted mr-1"></i>Cap. Pasajeros</th>
                                    <th
                                        style="padding: 12px 16px; font-weight: 600; font-size: 13px; color: #6b7280; text-align: center;">
                                        <i class="fas fa-box text-muted mr-1"></i>Cap. Carga</th>
                                    <th
                                        style="padding: 12px 16px; font-weight: 600; font-size: 13px; color: #6b7280; text-align: center;">
                                        <i class="fas fa-gas-pump text-muted mr-1"></i>Cap. Gasolina</th>
                                    <th style="padding: 12px 16px; font-weight: 600; font-size: 13px; color: #6b7280;"><i
                            ...
                            <tbody>
                                @forelse($tipo_vehiculos as $tipo)
                                    <tr style="border-bottom: 1px solid #f3f4f6;">
                                        <td style="padding: 12px 16px;"><input type="checkbox" class="row-checkbox"></td>
                                        <td style="padding: 12px 16px; color: #6b7280; font-weight: 600;">{{ $tipo->id }}</td>
                                        <td style="padding: 12px 16px;">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    style="width: 48px; height: 48px; border-radius: 8px; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); display: flex; align-items: center; justify-content: center; margin-right: 12px; color: white; font-weight: 700;">
                                                    <i class="fas fa-car"></i>
                                                </div>
                                                <div style="font-weight: 600; color: #1f2937;">{{ $tipo->nombre }}</div>
                                            </div>
                                        </td>
                                        <td style="padding: 12px 16px; color: #4b5563;">{{ Str::limit($tipo->descripcion, 40) }}
                                        </td>
                                        ...
                                        <td style="padding: 12px 16px; text-align: center;">
                                            <span
                                                style="background: #d1fae5; color: #065f46; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600;">
                                                {{ $tipo->capacidad_gasolina }} L
                                            </span>
                                        </td>
                                        <td style="padding: 12px 16px; color: #4b5563;">{{ $tipo->registrado_por }}</td>
                                        <td style="padding: 12px 16px; text-align: center;">
                                            <span class="status-badge" data-id="{{ $tipo->id }}" data-model="tipo_vehiculos"
                                                data-status="{{ $tipo->estado }}"
                                                style="background: {{ $tipo->estado ? '#d1fae5' : '#fee2e2' }}; color: {{ $tipo->estado ? '#047857' : '#dc2626' }}; padding: 6px 14px; border-radius: 12px; font-size: 12px; font-weight: 600; cursor: pointer;"
                                                onclick="toggleStatus(this)">
                                                {{ $tipo->estado ? 'Activo' : 'Inactivo' }}
                                            </span>
                                        </td>
                                        <td style="padding: 12px 16px; text-align: center;">
                                            <button onclick="window.location='{{ route('tipo_vehiculos.edit', $tipo->id) }}'"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center" style="padding: 40px;"><i class="fas fa-inbox"
                                                style="font-size: 48px; color: #9ca3af; display: block; margin-bottom: 16px;"></i>
                                            <p style="color: #9ca3af;">No hay tipos de vehículos registrados</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
