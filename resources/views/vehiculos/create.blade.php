                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('año') is-invalid @enderror"
                                                    ...
                                                    value="{{ old('año') }}" min="1900" max="{{ date('Y') + 1 }}" required>
                                                @error('año')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('color') is-invalid @enderror"
                                                    name="color" id="colorInput" placeholder="Ej: Rojo, Azul, Verde, Negro"
                                                    value="{{ old('color') }}" required>
                                                <small class="form-text text-muted">Escriba el nombre del color</small>
                                                @error('color')
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    autocomplete="off" value="{{ old('kilometraje') }}" min="0" required>
    ...
    @push('scripts')
        <script>
            $(document).ready(function () {
                ...
                // Establecer color inicial del picker basado en el texto si hay valor previo
